...
function findWasmBinary() {
  return locateFile('spin-diamond.wasm');
}
...
var ASM_CONSTS = {
  92648: () => { if (document.fullscreenElement) return 1; },  
 92694: () => { return Module.canvas.width; },  
 92726: () => { return parseInt(Module.canvas.style.width); },  
 92774: () => { document.exitFullscreen(); },  
 92801: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 92874: () => { if (document.fullscreenElement) return 1; },  
 92920: () => { return Module.canvas.width; },  
 92952: () => { return screen.width; },  
 92977: () => { document.exitFullscreen(); },  
 93004: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93137: () => { return window.innerWidth; },  
 93163: () => { return window.innerHeight; },  
 93190: () => { if (document.fullscreenElement) return 1; },  
 93236: () => { return Module.canvas.width; },  
 93268: () => { return parseInt(Module.canvas.style.width); },  
 93316: () => { if (document.fullscreenElement) return 1; },  
 93362: () => { return Module.canvas.width; },  
 93394: () => { return screen.width; },  
 93419: () => { return window.innerWidth; },  
 93445: () => { return window.innerHeight; },  
 93472: () => { if (document.fullscreenElement) return 1; },  
 93518: () => { return Module.canvas.width; },  
 93550: () => { return screen.width; },  
 93575: () => { document.exitFullscreen(); },  
 93602: () => { if (document.fullscreenElement) return 1; },  
 93648: () => { return Module.canvas.width; },  
 93680: () => { return parseInt(Module.canvas.style.width); },  
 93728: () => { document.exitFullscreen(); },  
 93755: ($0) => { Module.canvas.style.opacity = $0; },  
 93793: () => { return screen.width; },  
 93818: () => { return screen.height; },  
 93844: () => { return window.screenX; },  
 93871: () => { return window.screenY; },  
 93898: () => { return window.devicePixelRatio; },  
 93934: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93987: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94038: () => { Module.canvas.style.cursor = 'none'; },  
 94075: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94331: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94382: () => { if (document.pointerLockElement) return 1; },  
 94429: () => { if (document.fullscreenElement) return 1; },  
